...
# shopee_link = 'https://shopee.co.id/Laptop-Lenovo-T400-Cpu-2-4Ghz-Ram-4GB-SSD-128GB-500GB-Windows-10-Mulus-i.230649038.8711661572?sp_atk=6c5920d1-21ab-4ecc-ad71-1e80a1cb280b&xptdk=6c5920d1-21ab-4ecc-ad71-1e80a1cb280b'
...
def get_spesifikasi():
    try:
        return re.search(
            '<div class="RwsPNz">(.*)</div></div>', str(subkriteria_tag)).group(1).lower()
...
for subkriteria_tag in spesifikasi:
    ...
    if subkriteria == 'tipe prosesor':
        ...
        if(kondisi_produk):
            subkriteria_list.remove('kondisi')
